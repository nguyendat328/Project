...
if(isset($_SESSION['user'])){
    ...
    if(!empty($a)&&!empty($m)){
        ...
        }else{header("Location: $baseUrl/admin/views/404.php"); };

    }else{header("Location: $baseUrl/admin/?m=table&a=Analytics"); };
// CONTROL  LEFT SIDE-------------------
    $ar= array("Analytics","Type dog","Country","Dog food","Dog news","Gallery","Dog FAQ","Contact","Request"); 
 foreach($ar as $arr){
